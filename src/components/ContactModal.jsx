...
export default function ContactModal({ open, onClose, onSave, contact, courses }) {
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label>Name *</Label>
              <Input value={form.name || ''} onChange={(e) => set('name', e.target.value)} placeholder="Dr. Jane Patel" autoFocus />
            </div>
            <div className="space-y-1.5">
              <Label>Role</Label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input value={form.office_location || ''} onChange={(e) => set('office_location', e.target.value)} placeholder="Science Bldg, Rm 204" />
            </div>
            <div className="space-y-1.5">
